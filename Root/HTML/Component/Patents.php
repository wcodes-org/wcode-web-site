<div id='message'>
	...
	<div class='top-bottom-gap'>
		<?php $title='wcode-intro-youtube-video'; $ext='jpg'; $alt="WCode intro - YouTube video"; require('Fragment\Component_image.php') ?>
	</div>
	<p>
	...
	<div class='top-bottom-gap'>
		<?php $title='wcode-windows-app-x-lat-lng_highlighted'; $ext='png'; $alt="WCode desktop app - Lat-lng"; require('Fragment\Component_image.php') ?>
	</div>
	<p>
		E.g. coordinate: <strong>27°59′17″N 86°55′31″E</strong> transforms to: <span class="blue wcode">lift uncle cork rim screw</span>
	</p>
	<div class='top-bottom-gap'>
		<?php $title='wcode-windows-app-x-lat-lng_encode_highlighted'; $ext='png'; $alt="WCode desktop app - Lat-lng encode"; require('Fragment\Component_image.php') ?>
	</div>
	<p>
	...
	<h2>Conflict</h2>
	<p>
		A few years later I found out that a startup named “<strong><em>What3Words</em></strong>” in UK had applied for a patent on the same invention, with the only apparant difference being that their code is shorter with only 3 words while WCode had 5; But the disparity was primarily because WCode used a dictionary of only <strong class='blue'>1024</strong> simple words against the many thousands.<br>
	...
	<div class='top-bottom-gap'>
		<?php $title='patent_application_uk_ipo-GB1307148.5'; $ext='jpg'; $alt="W3W patent application, UK-IPO, GB1307148.5"; require('Fragment\Component_image.php') ?>
	</div>
	<p>
		...
		Thus I sought help on StackExchange Patents <a class='content-link' href='https://patents.stackexchange.com/questions/13629/i-had-invented-and-published-before-this-patent-application-how-do-i-get-it-in'>Q&A site</a>.
	</p>
	<p>
		I tried submitting a third party observation but was unable to since the priority date is past 28 months limit.<br>
