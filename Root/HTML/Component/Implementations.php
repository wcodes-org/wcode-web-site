<div class="message">
	<ul class="content-list">
		<li>
			...
			<ul class="content-list-2 content-list-no-style">
				...
				<li><span class="pending">&bull; iOS</span></li>
				<li><span class="pending">&bull; Web - Service</span></li>
			</ul>
		</li>
		<li>
	...
	<div class="legend">
		<span class="ready">&bull; Implemented</span>
		&nbsp;
		<span class="progress">&bull; In-progress</span>
		&nbsp;
